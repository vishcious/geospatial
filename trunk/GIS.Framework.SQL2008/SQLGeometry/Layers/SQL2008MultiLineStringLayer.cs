...
{
    public class SQL2008MultiLineStringLayer : SQL2008Layer
    {
        public SQL2008MultiLineStringLayer(IDbCommand dbComand, string shapeFieldName, string layerName, string keyFieldName)
