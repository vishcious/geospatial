...
{
    public class GISSerializableDictionary: SerializableDictionary, IGISAttributes, IGISXMLReadable, IGISJSONReadable
    {
        string[] _nonSerializedFields;

        public GISSerializableDictionary() { }
        
        public GISSerializableDictionary(string[] nonSerializedFields) 
        {
